...
<br />
<p>您收到这封邮件，是由于在 $sitename 获取了新用户注册地址使用 了这个邮箱地址。
如果您并没有访问过 $sitename，或没有进行上述操作，请忽略这封邮件。您不需要退订或进行其他进一步的操作。</p>
<br />
<br />
<p>----------------------------------------------------------------------</p>
<p>新用户注册说明</p>
<p>----------------------------------------------------------------------</p>
<br />
<p>如果您是 $sitename 的新用户，或在修改您的注册 Email 时使用了本地址，
我们需要对您的地址有效性进行验证以避免垃圾邮件或地址被滥用。</p>
<br />
...
<p>$sitename 管理团队.</p>";
	...
	function sentForgetEmail($to ,$url){
	$sitename=$this->sitename; 
									
	$subject="$sitename会员找回密码";
	$body="
<p>这封信是由 $sitename 发送的。</p>
<br />
<p>您收到这封邮件，是由于在 $sitename 获取了通过本邮件找回密码。
如果您并没有访问过 $sitename，或没有进行上述操作，请忽略这封邮件。您不需要退订或进行其他进一步的操作。</p>
<br />
<br />
<p>----------------------------------------------------------------------</p>
